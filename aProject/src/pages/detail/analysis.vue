  ...
  <div class="sales-board">
    <div class="sales-board-intro">
      ...
      <p>是指在获得网站访问量基本数据的情况下对有关数据进行统计、分析，
        ...
        从而发现目前网络营销活动中可能存在的问题，并为进一步修正或重新制
        定网络营销策略提供依据。当然这样的定义是站在网络营销管理的角度来考虑的
      </p>
    </div>
    ...
    <div class="sales-board-des">
      ...
      <p>网站访问统计分析报告的基础数据源于网站流量统计信息，
        但其价值远高于原始数据资料。专业的网站访问统计分析报告对
        网络营销的价值，正如专业的财务分析报告对企业经营策略的价值。
      </p>

      <h3>用户行为指标</h3>
      <ul>
        <li>用户行为指标主要反映用户是如何来到网站的、在网站上停留了
          多长时间、访问了哪些页面等，主要的统计指标包括：
        </li>
        <li>用户在网站的停留时间；</li>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        price: 0,
        isShowPayDialog: false, /*控制付钱窗口是否显示*/
        bankId: null, /*记录选择的银行*/
        orderId: null, /*记录订单号*/
        isShowCheckOrder: false, /*控制确认支付对话框状态*/
        buyNumberRange: {
          min: 1,
          max: 6
        },
